      ...
      <div className="grid grid-cols-12 gap-6">
        <div className="xl:col-span-9 col-span-12">
          <div className="box">
            ...
            <div className="box-body">
              <h5 className="font-semibold mb-4 Bid-title text-[1.25rem]">
              ...
              <div>
                <ul className="Bid-details-key-Bids mb-0 !ps-8">
                  <li>
          ...
          <div className="box">
            <div className="box-header">
              <div className="box-title">Bid Discussions</div>
            </div>
              ...
              <ul className="list-none profile-timeline">
                <li>
                  <div>
                    ...
                    <p className="mb-2">
                      <b>You</b> Commented on <b>Work Process</b> in this Bid{" "}
                    ...
                    <p className="text-[#8c9097] dark:text-white/50 mb-0">
                      Bid is important and need to be completed on time to meet
                      company work flow.
                    </p>
                  </div>
                </li>
                  ...
                  <div>
                    ...
                    <p className="text-[#8c9097] dark:text-white/50 mb-2">
                      <span className="text-default">
                        <b>Json Smith</b> reacted to the Bid 👍
                      </span>
                      .
                      <span className="ltr:float-right rtl:float-left text-[.6875rem] text-[#8c9097] dark:text-white/50">
                        18,Dec 2023 - 12:16
                ...
                <li>
                  <div>
                    ...
                    <p className="mb-1">
                      <b>Json</b> Commented on Bid post{" "}
                      <Link className="text-secondary" href="#!">
                        <u>#UI Technologies</u>
                      </Link>
                      .
        ...
        <div className="xl:col-span-3 col-span-12">
              ...
              <div className="table-responsive">
                <table className="table whitespace-nowrap min-w-full">
                  <tbody>
                    ...
                    <tr className="border-b border-defaultborder">
                      <td>
                        <span className="font-semibold">Bid Tags :</span>
                      </td>
                      <td>
          ...
          <div className="box overflow-hidden">
            <div className="box-header justify-between">
              <div className="box-title">Sub Bids</div>
              <div>
                <button
                  type="button"
                  className="ti-btn ti-btn-secondary !py-1 !px-2 !font-medium !text-[0.75rem]"
                >
                  <i className="ri-add-line  align-middle"></i>Sub Bid
                </button>
              </div>
            </div>
            <div className="box-body">
